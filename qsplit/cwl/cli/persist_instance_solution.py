...
def _safe_id_from_matrix(path: Path) -> str:
    stem = path.stem
    # StreamFlow staging can prepend numeric counters multiple times
    # (e.g. 000000_000012_<id>.csv). Strip all numeric prefixes.
    while True:
        # Only strip the fixed-width staging prefixes generated by this workflow.
